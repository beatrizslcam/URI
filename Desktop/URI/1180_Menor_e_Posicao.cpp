/*aça um programa que leia um valor N. Este N será o tamanho de um vetor X[N].
...
X[N] de inteiros. A segunda linha contém cada um dos N valores, separados por um espaço.
